      ...
      <div class="flex flex-col py-4 sm:flex-row sm:items-start">
        <section class="container relative mx-3s">
          <div class="mr-auto shrink-0 sm:py-3 px-5">
            <p class="text-3xl text-black">Data All Transaction</p>
          </div>
                          ...
                          {item.status == "Settlement" ? (
                            <td class="whitespace-nowrap px-4 py-4 text-sm font-medium text-gray-700">
                              <div class="inline-flex items-center gap-x-2 rounded-full bg-emerald-100/60 px-3 py-1 text-emerald-500 dark:bg-gray-800">
                                <Done className='w-5 h-5'/>

                                <h2 class="text-sm font-bold text-green-300">Settlement</h2>
                              </div>
                            </td>
                          ) : item.status == "Pending" ? (
                            <td class="whitespace-nowrap px-4 py-4 text-sm font-medium text-gray-700">
                              <div class="inline-flex items-center gap-x-2 rounded-full bg-yellow-100/60 px-3 py-1 text-yellow-500 dark:bg-gray-800">
                               <History className='w-5 h-5'/>

                                <h2 class="text-sm font-normal text-yellow-300">Pending</h2>
                              </div>
                            </td>
                              ) : null}
                              <td class="whitespace-nowrap px-4 py-4 text-sm text-yellow-500 dark:text-gray-300">
          ...
          <div class="mt-6 flex items-center justify-between px-5">
            ...
            <button
              ...
              disabled={currentPage * 9 >= totalOrder}
              href="#"
              class="cursor-pointer flex items-center gap-x-2 rounded-md border bg-white px-5 py-2 text-sm capitalize text-gray-700 transition-colors duration-200 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800"
            >
              <span>Next</span>
